...
class _Started implements RoutesEvent {
  const _Started();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RoutesState);
}
...
/// @nodoc
class $RoutesStateCopyWith<$Res>  {
$RoutesStateCopyWith(RoutesState _, $Res Function(RoutesState) __);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RoutesState);
}
